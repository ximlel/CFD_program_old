...
ar crv meshing.a Sod_mesh.o Free_mesh.o odd_even_mesh.o Shear_mesh.o Cylinder_mesh.o

cd ../cell_centered_scheme/
gcc -c ./linear_GRP_solver_Edir.c -I ../ -g
gcc -c ./first_order_solver.c -I ../
ar crv cell_centered_scheme.a linear_GRP_solver_Edir.o first_order_solver.o
