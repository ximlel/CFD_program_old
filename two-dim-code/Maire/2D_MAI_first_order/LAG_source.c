...
int main(int argc, char *argv[])
{
  ...
  double config[N_CONF];  /* config[0] is the polytropic index
                           * config[1] is the total time step
...
STEP=first_order_solver(config, NUM_CELL, NUM_POINT, NUM_BOUNDARY, CELL_POINT, BOUNDARY_POINT, RHO, U, V, P, X, Y, NORMAL_VELOCITY, gamma, cpu_time, argv[4], atof(argv[6])); 
